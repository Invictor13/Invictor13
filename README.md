...
> Busco aplicar os conceitos de Engenharia de Produção para transformar o suporte de TI em uma área cada vez mais ágil, organizada e orientada à eficiência operacional.

---

## 🎯 Principais Competências

* 💻 Desenvolvimento de Softwares (Foco em Python e Engenharia de Software)
* 🛠️ Gestão de Chamados & Suporte Técnico (Hardware, Redes e Sistemas)
* 🔄 Otimização de Processos de TI & Metodologias Ágeis (Scrum, Jira)
* 🤝 Atendimento ao Cliente & Alinhamento Operacional
* 📊 Análise Estatística & Visão de BI aplicadas a Indicadores de TI
